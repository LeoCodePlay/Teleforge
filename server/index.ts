...
import registerBasic from './http/basic.ts';
import registerProviders from './http/providers.ts';
import registerUiState from './http/ui-state.ts';
import registerTransfer from './http/transfer.ts';
import registerStatic from './http/static.ts';
