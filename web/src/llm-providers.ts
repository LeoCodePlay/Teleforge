...
const DEFAULT_CONTEXT: Record<string, ModelContextConfig> = {
  ...
  'gpt-4o': { ...MEGA_CONTEXT },
  'gpt-4o-mini': { ...MEGA_CONTEXT },
  'gpt-4.1': { ...MEGA_CONTEXT },
  'gpt-4.1-mini': { ...MEGA_CONTEXT },
  'gpt-4.1-nano': { ...MEGA_CONTEXT },
  'kimi-k2-0711-preview': { ...MEGA_CONTEXT },
  'kimi-k2-turbo-preview': { ...MEGA_CONTEXT },
  'moonshot-v1-128k': { ...MEGA_CONTEXT },
  'moonshot-v1-32k': { ...MEGA_CONTEXT },
  'glm-4.5': { ...MEGA_CONTEXT },
  'glm-4.5-air': { ...MEGA_CONTEXT },
  'qwen3-coder-plus': { ...MEGA_CONTEXT },
...
export const PROVIDERS: LlmProvider[] = [
  ...
  },
  {
    ...
    // 默认 reasoner(思考模式);切换为 chat 即关闭思考
    models: ['deepseek-reasoner', 'deepseek-chat'],
    modelConfig: pickCfg(['deepseek-reasoner', 'deepseek-chat']),
    note: 'deepseek-chat 为通用对话(V3.x),deepseek-reasoner 为推理模型,默认带思考过程'
  },
  {
    id: 'openai',
    name: 'OpenAI',
  ...
  },
  {
    ...
    modelConfig: pickCfg(['kimi-k2-0711-preview', 'kimi-k2-turbo-preview', 'moonshot-v1-32k', 'moonshot-v1-128k']),
  ...
  },
  {
    ...
    modelConfig: pickCfg(['glm-4.5', 'glm-4.5-air']),
  ...
  },
  {
    ...
    modelConfig: pickCfg(['qwen3-max', 'qwen-plus', 'qwen3-coder-plus']),
  ...
  },
  {
    ...
    modelConfig: pickCfg(['doubao-seed-1-6-250615', 'doubao-seed-1-6-flash-250615']),
